      ...
      {  
           ...
           {  
                ...
                {  
                     ...
                     echo '<script>window.location="low.php"</script>';  
                }  
           }  
      }  
 }  
 ...
 <html>  
      ...
      <body>  
           ...
           <div class="container" style="width:700px;">  
                ...
                <div class="col-md-4">  
                     <form method="post" action="low.ph">  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td></td>  
                               <td><a href="moha.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
